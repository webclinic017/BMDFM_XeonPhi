...
Example of a User Defined Function:
  ...
  void my_function(const void *rt_ctrl, const ULO *dat_ptr,
    ...
    ret_ival(rt_ctrl,dat_ptr+1,(SLO*)&f_array);  // arg1: float ptr (f_array)
    ...
    (*(fcall)*tmp_ptr)(rt_ctrl,tmp_ptr+1,&dat);  //       universal data (dat)
...
extern void func__mapcar(const void*, const ULO*, struct fastlisp_data*);
extern void func__dummy_s(const void*, const ULO*, struct fastlisp_data*);
extern void *get_rt_ctrl(void);
...
CHR flp_eval(CHR *flp_expr, struct fastlisp_data *ret_dat){
  ...
  *((CHR**)flp_fnc)=flp_fnc+sizeof(ULO);
  func__mapcar(get_rt_ctrl(),(ULO*)flp_fnc,&res);
...
extern void FLP_MALLOC(const void*, const ULO*, struct fastlisp_data*);
extern void FLP_FREE(const void*, const ULO*, struct fastlisp_data*);
extern void func__dummy_i(const void*, const ULO*, struct fastlisp_data*);
extern void *get_rt_ctrl(void);
...
void *flp_malloc(SLO bytes){
  ...
  lcat(&flp_fnc,temp);
  *((CHR**)flp_fnc)=flp_fnc+sizeof(ULO);
  FLP_MALLOC(get_rt_ctrl(),(ULO*)flp_fnc,&res);
  addr=res.value.ival;
  free_flp_data(&res);
  free_string(&flp_fnc);
  free_string(&temp);
...
void flp_free(SLO addr){
  ...
  lcat(&flp_fnc,temp);
  *((CHR**)flp_fnc)=flp_fnc+sizeof(ULO);
  FLP_FREE(get_rt_ctrl(),(ULO*)flp_fnc,&res);
  free_flp_data(&res);
  free_string(&flp_fnc);
  free_string(&temp);
  return;
